(function() {
	tinymce.create('tinymce.plugins.wsRawHtmlPlugin', {
		...
		init : function(ed, url) {
			...
			var placeholderSrc = rawhtml_placeholder_image;
			...
			ed.onBeforeSetContent.add(function(ed, o) {
				o.content = o.content.replace(
					...
					function(content){
						...
						var placeholder = '<img alt="'+alt+'" class="'+placeholderClass+' mceItemNoResize" title="'+placeholderTitle+'" src="'+placeholderSrc+'" />';
						return placeholder;
					}
				)
			});
